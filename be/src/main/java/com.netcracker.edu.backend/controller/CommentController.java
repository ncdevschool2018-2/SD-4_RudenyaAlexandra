...
public class CommentController {
    ...
    public Page<Comment> getPage(@PageableDefault( sort = {"commentId"}, direction = Sort.Direction.DESC) Pageable pageable) {
        return this.commentService.getCommentPage(pageable);
    }
}
